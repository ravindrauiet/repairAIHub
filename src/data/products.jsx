...
export const bookingDevices = {
  ...
  'mobile-repair': {
    brands: [
      ...
      { id: 'redmi-mobile', name: 'Redmi' },
      { id: 'poco-mobile', name: 'POCO' },
      { id: 'oppo-mobile', name: 'OPPO' },
      { id: 'vivo-mobile', name: 'Vivo' },
      { id: 'iqoo-mobile', name: 'iQOO' },
      ...
      { id: 'huawei-mobile', name: 'Huawei' },
      { id: 'infinix-mobile', name: 'Infinix' },
      { id: 'itel-mobile', name: 'Itel' },
      { id: 'tecno-mobile', name: 'Tecno' },
      { id: 'lava-mobile', name: 'Lava' },
      { id: 'micromax-mobile', name: 'Micromax' },
      { id: 'karbonn-mobile', name: 'Karbonn' },
      { id: 'intex-mobile', name: 'Intex' },
      { id: 'xolo-mobile', name: 'Xolo' },
      { id: 'lyf-mobile', name: 'LYF' },
      { id: 'jio-mobile', name: 'Jio' },
      { id: 'smartron-mobile', name: 'Smartron' },
      { id: 'yu-mobile', name: 'Yu Televentures' },
      { id: 'zen-mobile', name: 'Zen Mobile' },
      { id: 'swipe-mobile', name: 'Swipe' },
      { id: 'spice-mobile', name: 'Spice' },
      { id: 'videocon-mobile', name: 'Videocon' },
      { id: 'iball-mobile', name: 'iBall' },
      { id: 'sony-mobile', name: 'Sony' },
      { id: 'panasonic-mobile', name: 'Panasonic' },
      { id: 'htc-mobile', name: 'HTC' },
      { id: 'asus-mobile', name: 'ASUS' },
      { id: 'lenovo-mobile', name: 'Lenovo' },
      { id: 'gionee-mobile', name: 'Gionee' },
      { id: 'coolpad-mobile', name: 'Coolpad' },
      { id: 'leeco-mobile', name: 'LeEco' },
      { id: 'meizu-mobile', name: 'Meizu' },
      { id: 'zte-mobile', name: 'ZTE' },
      { id: 'nubia-mobile', name: 'Nubia' },
      { id: 'blackberry-mobile', name: 'BlackBerry' },
      { id: 'alcatel-mobile', name: 'Alcatel' },
      { id: 'tcl-mobile', name: 'TCL' },
      { id: 'ulefone-mobile', name: 'Ulefone' },
      { id: 'umidigi-mobile', name: 'Umidigi' },
      { id: 'unihertz-mobile', name: 'Unihertz' },
      { id: 'vertu-mobile', name: 'Vertu' },
      { id: 'nothing-mobile', name: 'Nothing' },
      { id: 'cmf-mobile', name: 'CMF' },
      { id: 'ziox-mobile', name: 'Ziox' },
      { id: 'zopo-mobile', name: 'Zopo' },
      { id: 'zync-mobile', name: 'Zync' },
      { id: 'wiio-mobile', name: 'Wiio' },
      { id: 'wickedleak-mobile', name: 'Wickedleak' },
      { id: 'tambo-mobile', name: 'Tambo' },
      { id: 'sunstrike-mobile', name: 'Sunstrike' },
      { id: 'smartisan-mobile', name: 'Smartisan' },
      { id: 'sirin-mobile', name: 'Sirin' },
      { id: 'turing-mobile', name: 'Turing' },
      { id: 'vaio-mobile', name: 'Vaio' },
      { id: 'viaan-mobile', name: 'Viaan' },
      { id: 'yota-mobile', name: 'Yota Devices' },
      { id: 'yandex-mobile', name: 'Yandex' },
      { id: 'yamada-mobile', name: 'Yamada Denki' },
      { id: 'zuk-mobile', name: 'Zuk' },
      { id: 'symphony-mobile', name: 'Symphony' }
    ],
    models: {
      'samsung-mobile': [
      ...
      'redmi-mobile': [
        ...
        { id: 'redmi-note-12-pro-plus', name: 'Redmi Note 12 Pro+' },
        { id: 'redmi-note-12-pro', name: 'Redmi Note 12 Pro' },
        { id: 'redmi-note-12', name: 'Redmi Note 12' },
        { id: 'redmi-note-11-pro-plus', name: 'Redmi Note 11 Pro+' },
        { id: 'redmi-note-11-pro', name: 'Redmi Note 11 Pro' },
        { id: 'redmi-note-11', name: 'Redmi Note 11' },
        { id: 'redmi-note-10-pro-max', name: 'Redmi Note 10 Pro Max' },
        { id: 'redmi-note-10-pro', name: 'Redmi Note 10 Pro' },
        { id: 'redmi-note-10', name: 'Redmi Note 10' },
        { id: 'redmi-note-9-pro-max', name: 'Redmi Note 9 Pro Max' },
        { id: 'redmi-note-9-pro', name: 'Redmi Note 9 Pro' },
        { id: 'redmi-note-9', name: 'Redmi Note 9' },
        { id: 'redmi-note-8-pro', name: 'Redmi Note 8 Pro' },
        { id: 'redmi-note-8', name: 'Redmi Note 8' },
        { id: 'redmi-note-7-pro', name: 'Redmi Note 7 Pro' },
        { id: 'redmi-note-7', name: 'Redmi Note 7' },
        { id: 'redmi-note-6-pro', name: 'Redmi Note 6 Pro' },
        { id: 'redmi-note-5-pro', name: 'Redmi Note 5 Pro' },
        { id: 'redmi-note-5', name: 'Redmi Note 5' },
        { id: 'redmi-note-4', name: 'Redmi Note 4' },
        { id: 'redmi-note-3', name: 'Redmi Note 3' },
        { id: 'redmi-12', name: 'Redmi 12' },
        { id: 'redmi-12c', name: 'Redmi 12C' },
        { id: 'redmi-11-prime', name: 'Redmi 11 Prime' },
        { id: 'redmi-10-prime', name: 'Redmi 10 Prime' },
        { id: 'redmi-10', name: 'Redmi 10' },
        { id: 'redmi-9-power', name: 'Redmi 9 Power' },
        { id: 'redmi-9-prime', name: 'Redmi 9 Prime' },
        { id: 'redmi-9', name: 'Redmi 9' },
        { id: 'redmi-8a', name: 'Redmi 8A' },
        { id: 'redmi-8', name: 'Redmi 8' },
        { id: 'redmi-7a', name: 'Redmi 7A' },
        { id: 'redmi-7', name: 'Redmi 7' },
        { id: 'redmi-6a', name: 'Redmi 6A' },
        { id: 'redmi-6-pro', name: 'Redmi 6 Pro' },
        { id: 'redmi-6', name: 'Redmi 6' },
        { id: 'redmi-5a', name: 'Redmi 5A' },
        { id: 'redmi-5-plus', name: 'Redmi 5 Plus' },
        { id: 'redmi-5', name: 'Redmi 5' },
        { id: 'redmi-4a', name: 'Redmi 4A' },
        { id: 'redmi-4', name: 'Redmi 4' },
        { id: 'redmi-3s-prime', name: 'Redmi 3S Prime' },
        { id: 'redmi-3s', name: 'Redmi 3S' },
        { id: 'redmi-2-prime', name: 'Redmi 2 Prime' },
        { id: 'redmi-2', name: 'Redmi 2' },
        { id: 'redmi-1s', name: 'Redmi 1S' }
      ],
      'poco-mobile': [
        { id: 'poco-f5-pro', name: 'POCO F5 Pro' },
        { id: 'poco-f5', name: 'POCO F5' },
        { id: 'poco-f4-gt', name: 'POCO F4 GT' },
        { id: 'poco-f4', name: 'POCO F4' },
        { id: 'poco-f3-gt', name: 'POCO F3 GT' },
        { id: 'poco-f3', name: 'POCO F3' },
        { id: 'poco-f2-pro', name: 'POCO F2 Pro' },
        { id: 'poco-f1', name: 'POCO F1' },
        { id: 'poco-x6-pro', name: 'POCO X6 Pro' },
        { id: 'poco-x6', name: 'POCO X6' },
        { id: 'poco-x5-pro', name: 'POCO X5 Pro' },
        { id: 'poco-x5', name: 'POCO X5' },
        { id: 'poco-x4-pro', name: 'POCO X4 Pro' },
        { id: 'poco-x4-gt', name: 'POCO X4 GT' },
        { id: 'poco-x3-pro', name: 'POCO X3 Pro' },
        { id: 'poco-x3-gt', name: 'POCO X3 GT' },
        { id: 'poco-x3-nfc', name: 'POCO X3 NFC' },
        { id: 'poco-x3', name: 'POCO X3' },
        { id: 'poco-x2', name: 'POCO X2' },
        { id: 'poco-m6-pro', name: 'POCO M6 Pro' },
        { id: 'poco-m6', name: 'POCO M6' },
        { id: 'poco-m5s', name: 'POCO M5s' },
        { id: 'poco-m5', name: 'POCO M5' },
        { id: 'poco-m4-pro', name: 'POCO M4 Pro' },
        { id: 'poco-m4-5g', name: 'POCO M4 5G' },
        { id: 'poco-m3-pro', name: 'POCO M3 Pro' },
        { id: 'poco-m3', name: 'POCO M3' },
        { id: 'poco-m2-pro', name: 'POCO M2 Pro' },
        { id: 'poco-m2', name: 'POCO M2' },
        { id: 'poco-c65', name: 'POCO C65' },
        { id: 'poco-c55', name: 'POCO C55' },
        { id: 'poco-c50', name: 'POCO C50' },
        { id: 'poco-c40', name: 'POCO C40' }
      ],
      'iqoo-mobile': [
        { id: 'iqoo-12', name: 'iQOO 12' },
        { id: 'iqoo-11', name: 'iQOO 11' },
        { id: 'iqoo-neo-7', name: 'iQOO Neo 7' },
        { id: 'iqoo-neo-6', name: 'iQOO Neo 6' },
        { id: 'iqoo-9-pro', name: 'iQOO 9 Pro' },
        { id: 'iqoo-9', name: 'iQOO 9' },
        { id: 'iqoo-9-se', name: 'iQOO 9 SE' },
        { id: 'iqoo-z7-pro', name: 'iQOO Z7 Pro' },
        { id: 'iqoo-z7s', name: 'iQOO Z7s' },
        { id: 'iqoo-z7', name: 'iQOO Z7' },
        { id: 'iqoo-z6-lite', name: 'iQOO Z6 Lite' },
        { id: 'iqoo-z6-pro', name: 'iQOO Z6 Pro' },
        { id: 'iqoo-z6-44w', name: 'iQOO Z6 44W' },
        { id: 'iqoo-z6', name: 'iQOO Z6' },
        { id: 'iqoo-z5', name: 'iQOO Z5' },
        { id: 'iqoo-z3', name: 'iQOO Z3' },
        { id: 'iqoo-7-legend', name: 'iQOO 7 Legend' },
        { id: 'iqoo-7', name: 'iQOO 7' },
        { id: 'iqoo-3', name: 'iQOO 3' }
      ],
      'huawei-mobile': [
        { id: 'huawei-p60-pro', name: 'P60 Pro' },
        { id: 'huawei-p50-pro', name: 'P50 Pro' },
        { id: 'huawei-p50', name: 'P50' },
        { id: 'huawei-p40-pro-plus', name: 'P40 Pro+' },
        { id: 'huawei-p40-pro', name: 'P40 Pro' },
        { id: 'huawei-p40', name: 'P40' },
        { id: 'huawei-p30-pro', name: 'P30 Pro' },
        { id: 'huawei-p30', name: 'P30' },
        { id: 'huawei-p20-pro', name: 'P20 Pro' },
        { id: 'huawei-p20', name: 'P20' },
        { id: 'huawei-mate-50-pro', name: 'Mate 50 Pro' },
        { id: 'huawei-mate-40-pro', name: 'Mate 40 Pro' },
        { id: 'huawei-mate-30-pro', name: 'Mate 30 Pro' },
        { id: 'huawei-mate-20-pro', name: 'Mate 20 Pro' },
        { id: 'huawei-mate-20', name: 'Mate 20' },
        { id: 'huawei-mate-10-pro', name: 'Mate 10 Pro' },
        { id: 'huawei-mate-10', name: 'Mate 10' },
        { id: 'huawei-nova-11-pro', name: 'Nova 11 Pro' },
        { id: 'huawei-nova-10-pro', name: 'Nova 10 Pro' },
        { id: 'huawei-nova-9', name: 'Nova 9' },
        { id: 'huawei-nova-8', name: 'Nova 8' },
        { id: 'huawei-nova-7', name: 'Nova 7' },
        { id: 'huawei-nova-5t', name: 'Nova 5T' },
        { id: 'huawei-y9s', name: 'Y9s' },
        { id: 'huawei-y9-prime', name: 'Y9 Prime' },
        { id: 'huawei-y9', name: 'Y9' },
        { id: 'huawei-y7-prime', name: 'Y7 Prime' },
        { id: 'huawei-y6', name: 'Y6' }
      ],
      'infinix-mobile': [
        { id: 'infinix-hot-40', name: 'Hot 40' },
        { id: 'infinix-hot-30', name: 'Hot 30' },
        { id: 'infinix-hot-20', name: 'Hot 20' },
        { id: 'infinix-hot-12', name: 'Hot 12' },
        { id: 'infinix-hot-11', name: 'Hot 11' },
        { id: 'infinix-hot-10', name: 'Hot 10' },
        { id: 'infinix-note-30-pro', name: 'Note 30 Pro' },
        { id: 'infinix-note-30', name: 'Note 30' },
        { id: 'infinix-note-12', name: 'Note 12' },
        { id: 'infinix-note-11', name: 'Note 11' },
        { id: 'infinix-note-10-pro', name: 'Note 10 Pro' },
        { id: 'infinix-note-10', name: 'Note 10' },
        { id: 'infinix-zero-30', name: 'Zero 30' },
        { id: 'infinix-zero-20', name: 'Zero 20' },
        { id: 'infinix-zero-ultra', name: 'Zero Ultra' },
        { id: 'infinix-zero-5g', name: 'Zero 5G' },
        { id: 'infinix-smart-7', name: 'Smart 7' },
        { id: 'infinix-smart-6', name: 'Smart 6' },
        { id: 'infinix-smart-5', name: 'Smart 5' }
      ],
      'micromax-mobile': [
        { id: 'micromax-in-2c', name: 'IN 2c' },
        { id: 'micromax-in-2b', name: 'IN 2b' },
        { id: 'micromax-in-1b', name: 'IN 1b' },
        { id: 'micromax-in-1', name: 'IN 1' },
        { id: 'micromax-in-note-1', name: 'IN Note 1' },
        { id: 'micromax-canvas-infinity', name: 'Canvas Infinity' },
        { id: 'micromax-canvas-6-pro', name: 'Canvas 6 Pro' },
        { id: 'micromax-canvas-6', name: 'Canvas 6' },
        { id: 'micromax-canvas-5', name: 'Canvas 5' },
        { id: 'micromax-canvas-knight-2', name: 'Canvas Knight 2' },
        { id: 'micromax-canvas-silver-5', name: 'Canvas Silver 5' },
        { id: 'micromax-canvas-nitro-4g', name: 'Canvas Nitro 4G' },
        { id: 'micromax-canvas-nitro-2', name: 'Canvas Nitro 2' },
        { id: 'micromax-canvas-nitro', name: 'Canvas Nitro' },
        { id: 'micromax-canvas-juice-4g', name: 'Canvas Juice 4G' },
        { id: 'micromax-canvas-juice-3', name: 'Canvas Juice 3' },
        { id: 'micromax-canvas-juice-2', name: 'Canvas Juice 2' },
        { id: 'micromax-canvas-fire-4g', name: 'Canvas Fire 4G' },
        { id: 'micromax-canvas-2-plus', name: 'Canvas 2 Plus' },
        { id: 'micromax-canvas-2', name: 'Canvas 2' },
        { id: 'micromax-bharat-5', name: 'Bharat 5' },
        { id: 'micromax-bharat-4', name: 'Bharat 4' },
        { id: 'micromax-bharat-3', name: 'Bharat 3' },
        { id: 'micromax-bharat-2', name: 'Bharat 2' },
        { id: 'micromax-evok-note', name: 'Evok Note' },
        { id: 'micromax-evok-power', name: 'Evok Power' },
        { id: 'micromax-bolt-q339', name: 'Bolt Q339' },
        { id: 'micromax-bolt-supreme', name: 'Bolt Supreme' },
        { id: 'micromax-bolt-supreme-2', name: 'Bolt Supreme 2' }
      ],
      'lava-mobile': [
        { id: 'lava-agni-2', name: 'Agni 2' },
        { id: 'lava-agni', name: 'Agni' },
        { id: 'lava-blaze-2-pro', name: 'Blaze 2 Pro' },
        { id: 'lava-blaze-2', name: 'Blaze 2' },
        { id: 'lava-blaze-pro', name: 'Blaze Pro' },
        { id: 'lava-blaze', name: 'Blaze' },
        { id: 'lava-yuva-2-pro', name: 'Yuva 2 Pro' },
        { id: 'lava-yuva-2', name: 'Yuva 2' },
        { id: 'lava-z3', name: 'Z3' },
        { id: 'lava-z2', name: 'Z2' },
        { id: 'lava-z1', name: 'Z1' },
        { id: 'lava-z6', name: 'Z6' },
        { id: 'lava-z4', name: 'Z4' },
        { id: 'lava-benco-v80', name: 'Benco V80' },
        { id: 'lava-benco-v7', name: 'Benco V7' },
        { id: 'lava-a3', name: 'A3' },
        { id: 'lava-a1', name: 'A1' },
        { id: 'lava-x3', name: 'X3' },
        { id: 'lava-x1', name: 'X1' },
        { id: 'lava-iris-x8', name: 'Iris X8' },
        { id: 'lava-iris-x1', name: 'Iris X1' },
        { id: 'lava-pixel-v2', name: 'Pixel V2' },
        { id: 'lava-pixel-v1', name: 'Pixel V1' },
        { id: 'lava-iris-atom', name: 'Iris Atom' },
        { id: 'lava-iris-atom-3', name: 'Iris Atom 3' }
      ],
      'sony-mobile': [
        { id: 'sony-xperia-1-v', name: 'Xperia 1 V' },
        { id: 'sony-xperia-1-iv', name: 'Xperia 1 IV' },
        { id: 'sony-xperia-1-iii', name: 'Xperia 1 III' },
        { id: 'sony-xperia-1-ii', name: 'Xperia 1 II' },
        { id: 'sony-xperia-1', name: 'Xperia 1' },
        { id: 'sony-xperia-5-v', name: 'Xperia 5 V' },
        { id: 'sony-xperia-5-iv', name: 'Xperia 5 IV' },
        { id: 'sony-xperia-5-iii', name: 'Xperia 5 III' },
        { id: 'sony-xperia-5-ii', name: 'Xperia 5 II' },
        { id: 'sony-xperia-5', name: 'Xperia 5' },
        { id: 'sony-xperia-10-v', name: 'Xperia 10 V' },
        { id: 'sony-xperia-10-iv', name: 'Xperia 10 IV' },
        { id: 'sony-xperia-10-iii', name: 'Xperia 10 III' },
        { id: 'sony-xperia-10-ii', name: 'Xperia 10 II' },
        { id: 'sony-xperia-10', name: 'Xperia 10' },
        { id: 'sony-xperia-xz3', name: 'Xperia XZ3' },
        { id: 'sony-xperia-xz2-premium', name: 'Xperia XZ2 Premium' },
        { id: 'sony-xperia-xz2', name: 'Xperia XZ2' },
        { id: 'sony-xperia-xz1', name: 'Xperia XZ1' },
        { id: 'sony-xperia-xz-premium', name: 'Xperia XZ Premium' },
        { id: 'sony-xperia-xz', name: 'Xperia XZ' },
        { id: 'sony-xperia-x', name: 'Xperia X' },
        { id: 'sony-xperia-z5-premium', name: 'Xperia Z5 Premium' },
        { id: 'sony-xperia-z5', name: 'Xperia Z5' },
        { id: 'sony-xperia-z3-plus', name: 'Xperia Z3+' },
        { id: 'sony-xperia-z3', name: 'Xperia Z3' },
        { id: 'sony-xperia-z2', name: 'Xperia Z2' },
        { id: 'sony-xperia-z1', name: 'Xperia Z1' },
        { id: 'sony-xperia-z', name: 'Xperia Z' },
        { id: 'sony-xperia-c5-ultra', name: 'Xperia C5 Ultra' },
        { id: 'sony-xperia-c4', name: 'Xperia C4' },
        { id: 'sony-xperia-c3', name: 'Xperia C3' },
        { id: 'sony-xperia-m5', name: 'Xperia M5' },
        { id: 'sony-xperia-m4-aqua', name: 'Xperia M4 Aqua' }
      ],
      'htc-mobile': [
        { id: 'htc-u23-pro', name: 'U23 Pro' },
        { id: 'htc-u23', name: 'U23' },
        { id: 'htc-u20', name: 'U20' },
        { id: 'htc-u12-plus', name: 'U12+' },
        { id: 'htc-u12-life', name: 'U12 Life' },
        { id: 'htc-u11-plus', name: 'U11+' },
        { id: 'htc-u11', name: 'U11' },
        { id: 'htc-u-ultra', name: 'U Ultra' },
        { id: 'htc-u-play', name: 'U Play' },
        { id: 'htc-10', name: 'HTC 10' },
        { id: 'htc-one-a9', name: 'One A9' },
        { id: 'htc-one-m9-plus', name: 'One M9+' },
        { id: 'htc-one-m9', name: 'One M9' },
        { id: 'htc-one-m8', name: 'One M8' },
        { id: 'htc-one-m7', name: 'One M7' },
        { id: 'htc-desire-20-pro', name: 'Desire 20 Pro' },
        { id: 'htc-desire-19-plus', name: 'Desire 19+' },
        { id: 'htc-desire-12-plus', name: 'Desire 12+' },
        { id: 'htc-desire-12', name: 'Desire 12' },
        { id: 'htc-desire-10-pro', name: 'Desire 10 Pro' },
        { id: 'htc-desire-826', name: 'Desire 826' },
        { id: 'htc-desire-820', name: 'Desire 820' },
        { id: 'htc-desire-816', name: 'Desire 816' },
        { id: 'htc-desire-626', name: 'Desire 626' },
        { id: 'htc-desire-620', name: 'Desire 620' },
        { id: 'htc-desire-526', name: 'Desire 526' }
      ],
      'lenovo-mobile': [
        { id: 'lenovo-legion-y90', name: 'Legion Y90' },
        { id: 'lenovo-legion-pro', name: 'Legion Pro' },
        { id: 'lenovo-legion-duel', name: 'Legion Duel' },
        { id: 'lenovo-z6-pro', name: 'Z6 Pro' },
        { id: 'lenovo-z5-pro-gt', name: 'Z5 Pro GT' },
        { id: 'lenovo-z5-pro', name: 'Z5 Pro' },
        { id: 'lenovo-z5', name: 'Z5' },
        { id: 'lenovo-s5-pro', name: 'S5 Pro' },
        { id: 'lenovo-s5', name: 'S5' },
        { id: 'lenovo-k10-note', name: 'K10 Note' },
        { id: 'lenovo-k9-note', name: 'K9 Note' },
        { id: 'lenovo-k8-plus', name: 'K8 Plus' },
        { id: 'lenovo-k8-note', name: 'K8 Note' },
        { id: 'lenovo-k8', name: 'K8' },
        { id: 'lenovo-k6-power', name: 'K6 Power' },
        { id: 'lenovo-k6-note', name: 'K6 Note' },
        { id: 'lenovo-k5-note', name: 'K5 Note' },
        { id: 'lenovo-k5-plus', name: 'K5 Plus' },
        { id: 'lenovo-k4-note', name: 'K4 Note' },
        { id: 'lenovo-k3-note', name: 'K3 Note' },
        { id: 'lenovo-a7000', name: 'A7000' },
        { id: 'lenovo-a6000-plus', name: 'A6000 Plus' },
        { id: 'lenovo-a6000', name: 'A6000' },
        { id: 'lenovo-p2', name: 'P2' },
        { id: 'lenovo-a5000', name: 'A5000' },
        { id: 'lenovo-vibe-p1', name: 'Vibe P1' },
        { id: 'lenovo-vibe-x3', name: 'Vibe X3' },
        { id: 'lenovo-vibe-x2', name: 'Vibe X2' },
        { id: 'lenovo-vibe-z2-pro', name: 'Vibe Z2 Pro' }
      ],
      'tecno-mobile': [
        { id: 'tecno-phantom-v-fold', name: 'Phantom V Fold' },
        { id: 'tecno-phantom-x2-pro', name: 'Phantom X2 Pro' },
        { id: 'tecno-phantom-x2', name: 'Phantom X2' },
        { id: 'tecno-phantom-x', name: 'Phantom X' },
        { id: 'tecno-camon-20-premier', name: 'Camon 20 Premier' },
        { id: 'tecno-camon-20-pro', name: 'Camon 20 Pro' },
        { id: 'tecno-camon-20', name: 'Camon 20' },
        { id: 'tecno-camon-19-pro', name: 'Camon 19 Pro' },
        { id: 'tecno-camon-19', name: 'Camon 19' },
        { id: 'tecno-camon-18-premier', name: 'Camon 18 Premier' },
        { id: 'tecno-camon-18-pro', name: 'Camon 18 Pro' },
        { id: 'tecno-camon-18', name: 'Camon 18' },
        { id: 'tecno-camon-17-pro', name: 'Camon 17 Pro' },
        { id: 'tecno-camon-17', name: 'Camon 17' },
        { id: 'tecno-camon-16-premier', name: 'Camon 16 Premier' },
        { id: 'tecno-pova-4-pro', name: 'Pova 4 Pro' },
        { id: 'tecno-pova-4', name: 'Pova 4' },
        { id: 'tecno-pova-3', name: 'Pova 3' },
        { id: 'tecno-pova-2', name: 'Pova 2' },
        { id: 'tecno-pova', name: 'Pova' },
        { id: 'tecno-spark-10-pro', name: 'Spark 10 Pro' },
        { id: 'tecno-spark-10', name: 'Spark 10' },
        { id: 'tecno-spark-9-pro', name: 'Spark 9 Pro' },
        { id: 'tecno-spark-9', name: 'Spark 9' },
        { id: 'tecno-spark-8-pro', name: 'Spark 8 Pro' },
        { id: 'tecno-spark-8', name: 'Spark 8' },
        { id: 'tecno-spark-7-pro', name: 'Spark 7 Pro' },
        { id: 'tecno-spark-7', name: 'Spark 7' },
        { id: 'tecno-spark-6', name: 'Spark 6' },
        { id: 'tecno-spark-5-pro', name: 'Spark 5 Pro' }
      ],
      'blackberry-mobile': [
        { id: 'blackberry-key2-le', name: 'KEY2 LE' },
        { id: 'blackberry-key2', name: 'KEY2' },
        { id: 'blackberry-motion', name: 'Motion' },
        { id: 'blackberry-keyone', name: 'KEYone' },
        { id: 'blackberry-priv', name: 'Priv' },
        { id: 'blackberry-passport', name: 'Passport' },
        { id: 'blackberry-classic', name: 'Classic' },
        { id: 'blackberry-z30', name: 'Z30' },
        { id: 'blackberry-z10', name: 'Z10' },
        { id: 'blackberry-q10', name: 'Q10' },
        { id: 'blackberry-q5', name: 'Q5' },
        { id: 'blackberry-leap', name: 'Leap' },
        { id: 'blackberry-bold-9900', name: 'Bold 9900' },
        { id: 'blackberry-bold-9790', name: 'Bold 9790' },
        { id: 'blackberry-curve-9360', name: 'Curve 9360' },
        { id: 'blackberry-torch-9810', name: 'Torch 9810' }
      ],
      'jio-mobile': [
        { id: 'jio-phone-prima', name: 'JioPhone Prima' },
        { id: 'jio-phone-prima-4g', name: 'JioPhone Prima 4G' },
        { id: 'jio-phone-next', name: 'JioPhone Next' },
        { id: 'jio-phone-3', name: 'JioPhone 3' },
        { id: 'jio-phone-2', name: 'JioPhone 2' },
        { id: 'jio-phone', name: 'JioPhone' },
        { id: 'lyf-earth-1', name: 'LYF Earth 1' },
        { id: 'lyf-water-8', name: 'LYF Water 8' },
        { id: 'lyf-water-7', name: 'LYF Water 7' },
        { id: 'lyf-water-3', name: 'LYF Water 3' },
        { id: 'lyf-water-2', name: 'LYF Water 2' },
        { id: 'lyf-water-1', name: 'LYF Water 1' },
        { id: 'lyf-flame-8', name: 'LYF Flame 8' },
        { id: 'lyf-flame-7', name: 'LYF Flame 7' },
        { id: 'lyf-flame-6', name: 'LYF Flame 6' },
        { id: 'lyf-flame-5', name: 'LYF Flame 5' },
        { id: 'lyf-flame-4', name: 'LYF Flame 4' },
        { id: 'lyf-flame-3', name: 'LYF Flame 3' },
        { id: 'lyf-flame-2', name: 'LYF Flame 2' },
        { id: 'lyf-flame-1', name: 'LYF Flame 1' },
        { id: 'lyf-wind-7', name: 'LYF Wind 7' },
        { id: 'lyf-wind-6', name: 'LYF Wind 6' },
        { id: 'lyf-wind-5', name: 'LYF Wind 5' },
        { id: 'lyf-wind-4', name: 'LYF Wind 4' },
        { id: 'lyf-wind-3', name: 'LYF Wind 3' },
        { id: 'lyf-wind-2', name: 'LYF Wind 2' },
        { id: 'lyf-wind-1', name: 'LYF Wind 1' }
      ]
    }
  },
  'laptop-repair': {
